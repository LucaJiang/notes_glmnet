...
\section{Prostate Cancer Example}
    ...
    \begin{frame}{Comparison}
        \begin{figure}
            \centering
            \includegraphics[width=0.6\textwidth]{figures/Table 1.png}
            % \caption{Caption}
...
$$\mathbf{x}_{i}=Z_2+\epsilon_i^X,\quad Z_2\sim N(0,1),\quad i=11,...,15.$$
 ...
 $$\epsilon_i^x\stackrel{\mathrm{i.i.d.}}{\sim}N(0,0.01),\quad i=1,...,15$$
    ...
    \begin{frame}{Simulated Examples - Median MSE}
        \begin{figure}
            \centering
            \includegraphics[width=0.6\textwidth]{figures/Table 2.png}
            % \caption{Caption}
            \label{fig:enter-label}
        \end{figure}
        \begin{itemize}
    ...
    \begin{frame}{Simulated Examples - Median MSE}
        \begin{figure}
            \centering
            \includegraphics[width=0.45\textwidth]{figures/Fig 4.png}
            % \caption{Caption}
            \label{fig:enter-label}
        \end{figure}
        \begin{itemize}
    ...
    \begin{frame}{Simulated Examples - Variable Selection}
        \begin{figure}
            \centering
            \includegraphics[width=0.6\textwidth]{figures/Table 3.png}
            % \caption{Caption}
            \label{fig:enter-label}
        \end{figure}
        \begin{itemize}
